...
# The function should return True if num is greater than or equal to lower and
...
# An if statement that is always false is called a contradiction. You will
# rarely want to do this while programming, but it is important to realize it
